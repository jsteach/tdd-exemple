...
## Inspiration code serveur

Pour vous inspirer dans le développement du code du serveur et du client, vous pouvez utiliser cette [source](https://github.com/ReneNyffenegger/Socket.cpp).
